...
import com.leo.pro.databinding.ActivityNoFirstBinding;
import com.leo.pro.login.view.LoginActivity;
import com.leo.pro.utils.ActivityUtils;
import com.leo.pro.utils.RxCountDown;
...
public class NoFirstLaunchActivity extends Base2Activity<ActivityNoFirstBinding> {
    private static final String TAG = "NoFirstLaunchActivity" ;
    ...
    public int onSetContentView() {
        return R.layout.activity_no_first;
    }
